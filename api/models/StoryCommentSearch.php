...
class StoryCommentSearch extends StoryComment
{
    ...
    {
        $query = self::find()
            ->select(['{{%story_comment}}.id as comment_id','{{%story_comment}}.story_id','{{%story_comment}}.title','{{%story_comment}}.content','{{%story_comment}}.from_uid','{{%story_comment}}.from_uid','{{%story_comment}}.likes','{{%member}}.username','{{%member}}.nickname','{{%member}}.picture_url','{{%story}}.game_title','{{%story_comment}}.is_show','{{%story_comment}}.comment_type'])
