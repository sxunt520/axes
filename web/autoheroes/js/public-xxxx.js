...
var obj = {
    ...
    indexSwiper: function() {
		...
		var swiper_xxx = new Swiper('.swiper_xxx .swiper-container_xx', {
		  slidesPerView: 1,
		...
		swiper_xxx.scrollbar.$el.css('height','14px');
		//swiper_xxx.scrollbar.$dragEl.css('background-color','#DA954D');
		//swiper_xxx.scrollbar.$dragEl.css('background-img','../images/scroll_xxxx.png');
